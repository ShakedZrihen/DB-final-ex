    ...
    $.fn.Tabledit = function(options) {
        ...
        var defaults = {
            ...
            buttons: {
                edit: {
                    ...
                    html: ' <i class="material-icons md-dark pmd-sm">edit</i>',
                    action: 'edit'
                },
                delete: {
                    class: 'btn pmd-btn-fab pmd-btn-flat pmd-ripple-effect btn-default btn-sm',
                    html: '<i class="material-icons md-dark pmd-sm">delete</i>',
                    action: 'delete'
                },
                save: {
        ...
        var Edit = {
            ...
            submit: function(td) {
                ...
                xhttp.open("POST", "/engineers/edit", true);
                xhttp.send(settings.buttons.edit.action);
